...
########################################################################
from openpyxl import load_workbook #Imported the Module for processing Excel
import os
...
class excel_parcer:
    ...
    def make_list_client (self): # This Will make a client list
...
iig_upstream_html = iig_upstream.upstream_html(iig_upstream_list)
...
print("**                      / (^_^)                           **")
print("**           We will meet on your next night!             **")
print("************************************************************")
print("************************************************************")
